        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 30px;">
            <div>
                <div style="margin-bottom: 20px;">
                    <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #475569;">Tên dịch vụ</label>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <textarea id="editor" name="description" style="width: 100%; min-height: 250px; border: 1px solid #cbd5e1; border-radius: 8px;"></textarea>
                </div>
            </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
                ...
                <button type="submit" style="width: 100%; background: #4f46e5; color: white; padding: 14px; border: none; border-radius: 8px; font-weight: 700; cursor: pointer; transition: 0.3s; font-size: 15px;">
